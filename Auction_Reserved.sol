//RESERVE BID AUCTION - At the the end of the auction the auction owner can accept the "winning" bid or reject it and cancel the auction

pragma solidity ^0.6.4;

contract AuctionReserved {
    ...
    event RejectedEvent(string message, uint256 time);
    ...
    function cancel_auction() public only_owner returns (bool) {
        //THE OWNER CAN CANCEL THE AUCTION AT ANY TIME EITHER BEFORE THE AUCTION ENDS OR AFTER IT ENDS
        ...
        if(now<auction_end){
              ...
              RejectedEvent("Sorry your auction has been rejected, you can withdraw your bid", now); 
        }
